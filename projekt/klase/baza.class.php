...
class Baza {
    ...
    const korisnik = "WebDiP2021x088"; /*barka: WebDiP2021x088*/
    const lozinka = "admin_xVhV"; /* barka: admin_xVhV*/
    const baza = "WebDiP2021x088"; /* lokalno: napraviti bazu, barka: WebDiP2021xMK*/
