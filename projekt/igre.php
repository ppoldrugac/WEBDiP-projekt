...
if (isset($_GET['gumbDodaj'])) {
    if ($_GET['idIgre'] == "") {
        ...
        $upitZaDodavanjeLutrije = "INSERT INTO `Igra_na_srecu` (`id`, `Korisnik_id`, `naziv`, `broj_brojeva_za_izvlacenje`, `cijena_listica`,"
                . " `datumvrijeme_pocetka`, `datumvrijeme_zavrsetka`, `fond_dobitka`) VALUES (NULL, NULL, '$nazivAzur', '$brojAzur', '$cijenaAzur', '$datumOdAzur', '$datumDoAzur', '$fondAzur')";
...
$upit = "SELECT * FROM `Igra_na_srecu`";
...
<html lang="hr">
    <head>
        <title>Upravljanje igrama na sreću</title>
        <meta charset="utf-8">
    ...
    <body id="vrh">
        ...
        <form novalidate id="formLutrije" method="get" name="formLutrije" action="igre.php">       
            <div id="okoTablice">
                <table id="tablica">
        ...
        <div class="containerProjekt3">
            <form novalidate id="formProjekt" method="get" name="formLutrijeAzuriraj" action="igre.php">
